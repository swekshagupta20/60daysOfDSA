public class permutations_of_string_distinct_noRepetition_contains_backtracking {
    ...
    public static void permutation(String s, StringBuilder sb){
        ...
        for(int i=0; i<s.length(); i++){
            ...
            char ch = s.charAt(i);
            if(sb.indexOf(Character.toString(ch))==-1){ // if character is not present, we add it to sb then delete it 
                sb.append(ch);
                permutation(s, sb);
